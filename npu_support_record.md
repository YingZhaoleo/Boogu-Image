...
- Removed `torchvision` imports from inference entrypoints and replaced the small image conversion usage with local PIL/Torch helpers to avoid loading unavailable torchvision CUDA ops.
